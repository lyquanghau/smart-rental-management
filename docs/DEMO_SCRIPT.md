...
- Neu demo luong tenant, ghi lai username va mat khau tam ngay khi tao hop dong active.
...
6. Neu he thong hien tai khoan tam cua tenant, ghi lai username va mat khau tam.
...
- Khong thay credential tenant: tenant da co user tu truoc; dung nut cap lai mat khau trong trang Khach thue.
